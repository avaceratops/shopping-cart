...
export const GAME_DESCRIPTIONS = {
  'warhammer-40k':
    "Embark on an intergalactic odyssey with Warhammer 40,000 at Shopping Cart. Whether you're a seasoned warrior or a newcomer, our extensive array of miniatures, rulebooks, and accessories promises an immersive gaming experience like no other. From the mighty Space Marines to the cunning Orks and beyond, gather your forces and brace yourself for epic tabletop battles.\n\nTake advantage of competitive prices that allow you to bolster your armies without compromise. Need help assembling your army? Our knowledgeable staff are on hand to offer assistance every step of the way. And with free delivery on all orders over £50, conquering the galaxy has never been more convenient.",
  'age-of-sigmar':
